# scripts/visuals/liquids/tap/PLUS_x_Mismatch_Rate_PR_tap.R
...
PLUS_MISMATCH_RATE_PR_tap <- pr_rates_mismatch_all %>%
  ...
  labs(x = "PLUS", y = "Mismatch Rate (%)\n",
       title = "Rate of Phonetic-Phonological Mismatch for /ɾ/ by PLUS for Puerto Rican Speakers",
       caption = "Data Source: Spanish in Boston Corpus \n Vidal-Covas Dissertation"
  ) +
  basic_custom_theme() +
  scale_y_continuous(limits = c(0, 100))  # Set the y-axis limits from 0 to 100

PLUS_MISMATCH_RATE_PR_tap