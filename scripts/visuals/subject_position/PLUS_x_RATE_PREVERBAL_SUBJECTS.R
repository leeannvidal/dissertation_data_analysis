...
PLUS_x_RATE_PREVERBAL_SUBJECTS <- rates_all_variables %>%
  ggplot(aes(x = PLUS, y = RATE_ALL_PREVERBAL_SUBJECTS)) +
...
PLUS_x_RATE_PREVERBAL_SUBJECTS

# ggsave("output/plots/subject_position/PLUS_preverbal_subjects.pdf", PLUS_x_RATE_PREVERBAL_SUBJECTS,device = cairo_pdf, width = 12, height = 10)
ggsave("output/plots/subject_position/PLUS_preverbal_subjects.pdf", PLUS_x_RATE_PREVERBAL_SUBJECTS,device = cairo_pdf, width = 8, height = 8)
