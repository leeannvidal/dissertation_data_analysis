# scripts/visuals/filled_pauses/PLUS_x_RATE_CENTRALIZED_fps.R

# Plot the data - fps

# Create the plot with annotations for R^2 and p-value
PLUS_RATE_CENTRALIZED_fps <- rates_all_variables %>%
...
PLUS_RATE_CENTRALIZED_fps

# ggsave("output/plots/filled_pauses/PLUS_centralized_fps.pdf", PLUS_RATE_CENTRALIZED_fps,device = cairo_pdf, width = 12, height = 10)
ggsave("output/plots/filled_pauses/PLUS_centralized_fps.pdf", PLUS_RATE_CENTRALIZED_fps,device = cairo_pdf, width = 8, height = 8)
