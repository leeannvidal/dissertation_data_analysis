...
PLUS_RATE_PRONOUNS_PRESENT_ALL_SIB <- rates_all_SIB %>%
  ...
  labs(x = "PLUS", y = "Presence Rate (%)\n",
       ...
       # title = "Association between Percent Life in the US (PLUS) \n and Pronoun Presence among 80 Bostonians\n",
       subtitle = "Pronouns",
       # caption = "Data Source: Spanish in Boston Corpus\n"
       ) +
  basic_custom_theme()

PLUS_RATE_PRONOUNS_PRESENT_ALL_SIB

ggsave("output/plots/pronouns/PLUS_present_pronouns_ALL_SIB.pdf", PLUS_RATE_PRONOUNS_PRESENT_ALL_SIB,device = cairo_pdf, width = 8, height = 8)
