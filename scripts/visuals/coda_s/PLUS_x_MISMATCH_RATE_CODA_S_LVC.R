# scripts/visuals/coda_s/PLUS_x_MISMATCH_RATE_CODA_S.R

# Plot the data - coda s

# Create the plot with annotations for R^2 and p-value
PLUS_x_RATE_MISMATCH_CODA_S_LVC <- rates_all_variables %>%
...
PLUS_x_RATE_MISMATCH_CODA_S_LVC

ggsave("output/plots/coda_s/PLUS_coda_s_mismatch_LVC.pdf", PLUS_x_RATE_MISMATCH_CODA_S_LVC,device = cairo_pdf, width = 8, height = 8)
